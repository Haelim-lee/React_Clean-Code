...
import FreeBoard from './FreeBoard/Mobile';
import NewsBoard from './NewsBoard/Mobile';
import QaBoard from './QaBoard/Mobile';
import DeveloperNoteBoard from './DeveloperNoteBoard/Mobile';
import './style.css';
...
function Board(props){
  ...
  useEffect(() =>{
    ...
    ReactDOM.render(<FreeBoard  Selecter={ActiveFind}  LinkAction={true}  Data={Data}/>,document.getElementById('Board_View'));
    else if(props.Type === 'NewsBoard')
      ReactDOM.render(<NewsBoard  Selecter={ActiveFind}  LinkAction={true}  Data={Data}/>,document.getElementById('Board_View'));
    else if(props.Type === 'QaBoard')
      ReactDOM.render(<QaBoard  Selecter={ActiveFind}  LinkAction={true} Data={Data}/>,document.getElementById('Board_View'));
    else if(props.Type === 'DeveloperNoteBoard')
      ReactDOM.render(<DeveloperNoteBoard  Selecter={ActiveFind}  LinkAction={true} Data={Data}/>,document.getElementById('Board_View'));
    else
      ReactDOM.render(<FreeBoard Selecter={ActiveFind}  LinkAction={true} />,document.getElementById('Board_View'));
  }, []);
  return (
      <div className='TabControl'>
          <p className='Screen' align='center'>
          <div className='TabPage'>
            <ul className="SubNav">
            <li><a className="" ref={News}  id="NEWS" href="#NewsBoard"  onClick={()=>ActiveCheck(News,MenuArray)}> 공지사항</a></li>
            <li><a className="" ref={DeveloperNote}  id="DEVELOPERNOTE" href="#DeveloperNoteBoard"  onClick={()=>ActiveCheck(DeveloperNote,MenuArray)}> 개발자노트</a></li>
            <li><a className="TabActive" ref={Free}  id="FREE" href="#FreeBoard"  onClick={()=>ActiveCheck(Free,MenuArray)}> 자유게시판</a></li>
            <li><a className="" ref={QA}  id="QA" href="#QnA"  onClick={()=>ActiveCheck(QA,MenuArray)}> Q&A</a></li>
          </ul>
          <div id='Board_View'/>
        </div>
          </p>
