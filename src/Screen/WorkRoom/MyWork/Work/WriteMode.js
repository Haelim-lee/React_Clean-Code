...
function WriteMode(props){
    ...
    const [SendData,setSendData] = useState({"num":"", "id":"", "name":"", "title":"", "contents":"", "category":""});
    ...
    const DataSubmit = (SendData) =>{
      if(props.Data === undefined)
        fetch('http://antsnest.co.kr:4000/InsertWorkBoard', {
          method: 'POST',
          mode: 'cors',
          ...
          fetch('http://antsnest.co.kr:4000/UpdateWorkBoard', {
            method: 'POST',
            mode: 'cors',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(SendData)}
