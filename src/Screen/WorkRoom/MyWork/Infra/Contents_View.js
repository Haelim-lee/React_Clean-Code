...
function Contents_View(props){
  ...
  const [SendData,setSendData] = useState({"noticeNum":"", "id":"", "name":"", "commentText":""});
    ...
    const DeleteItem=()=>{
        fetch('http://antsnest.co.kr:4000/DeleteInfraInfraBoard', {
            method: 'POST',
            mode: 'cors',
    ...
    const InsertComment = (Data) => {
      fetch('http://antsnest.co.kr:4000/InsertInfraComment',{
        method: 'POST',
        mode: 'cors',
        credentials:'include',
        headers: { 'Content-Type': 'application/json' },
    ...
    const DeleteComment = (Data) => {
      fetch('http://antsnest.co.kr:4000/DeleteInfraComment',{
        method: 'POST',
        mode: 'cors',
        credentials:'include',
        headers: { 'Content-Type': 'application/json' },
